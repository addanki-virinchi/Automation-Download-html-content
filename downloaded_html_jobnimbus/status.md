...
[![JobNimbus logo](//dka575ofm4ao0.cloudfront.net/pages-transactional_logos/retina/196734/JN_Logo_Full-Blue.png)](https://www.jobnimbus.com)

Get email notifications whenever JobNimbus **creates** , **updates** or **resolves** an incident. 
...
By subscribing you agree to our [Privacy Policy](https://www.jobnimbus.com/privacy-policy/).

This site is protected by reCAPTCHA and the Google [Privacy Policy](https://policies.google.com/privacy) and [Terms of Service](https://policies.google.com/terms) apply.

Get text message notifications whenever JobNimbus **creates** or **resolves** an incident. 
...
Message and data rates may apply. By subscribing you agree to our [Privacy Policy](https://www.jobnimbus.com/privacy-policy/), the Atlassian [Terms of Service](https://www.atlassian.com/legal/product-specific-terms#statuspage-specific-terms), and the Atlassian [Privacy Policy](https://www.atlassian.com/legal/privacy-policy). This site is protected by reCAPTCHA and the Google [Privacy Policy](https://policies.google.com/privacy) and [Terms of Service](https://policies.google.com/terms) apply.

Get webhook notifications whenever JobNimbus **creates** an incident, **updates** an incident, **resolves** an incident or **changes** a component status. 
...
Visit our [support site](https://www.jobnimbus.com/contactus/). 

Get the [Atom Feed](https://status.jobnimbus.com/history.atom) or [RSS Feed](https://status.jobnimbus.com/history.rss). 

##  All Systems Operational 

##  About This Site

This is the JobNimbus status page, where you can get updates on how our applications and core features are performing. If there are any interruptions to service, we will post an update here.   
  
If you experience any issues with JobNimbus that are not reflected here, please contact us at [support@jobnimbus.com](mailto:support@jobnimbus.com) and we'll get back to you as soon as possible. 

Login  Operational 

Web Application Performance  ? Operational 

Mobile Application Performance  ? Operational 

Email  Operational 

Email - Outbound  ? Operational 

Email - Inbound  ? Operational 

Engage  Operational 

QuickBooks Integration  Operational 

Receiving Payments  ? Operational 

Partner Integrations  Operational 

Public API - Application Programming Interface  ? Operational 
...
###  [ Planned Reporting System (Insights) Maintenance ](https://status.jobnimbus.com/incidents/2p5t70q65hjb "Planned Reporting System \(Insights\) Maintenance") Jan  2, 2026 18:00 \- Jan  4, 2026 00:00 MST 

We will be performing routine Insights maintenance the first weekend in January. Data updates will be paused during this time but resume once completed. Thank you for patience and support.   
Posted on Dec 18, 2025 \- 15:33 MST 
